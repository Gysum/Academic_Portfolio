      ...
      <div className="w-full relative flex flex-col items-center justify-center">
        <div className="w-full relative flex items-center justify-center">
          ...
          {CERTIFICATES.length > 1 && (
            <button
              onClick={handlePrev}
              className="hidden md:flex absolute left-4 z-10 w-10 h-10 rounded-full border border-white/10 hover:border-[#00F29D]/30 bg-[#0D0D0D] items-center justify-center text-white hover:text-[#00F29D] transition-all cursor-pointer"
          ...
          <div 
            className="w-full max-w-3xl overflow-hidden px-0 md:px-10"
          ...
          {CERTIFICATES.length > 1 && (
            <button
              onClick={handleNext}
              className="hidden md:flex absolute right-4 z-10 w-10 h-10 rounded-full border border-white/10 hover:border-[#00F29D]/30 bg-[#0D0D0D] items-center justify-center text-white hover:text-[#00F29D] transition-all cursor-pointer"
        ...
        {/* Mobile controls (underneath the card) */}
        {CERTIFICATES.length > 1 && (
          <div className="flex md:hidden items-center justify-center gap-6 mt-6 select-none">
            <button
              onClick={handlePrev}
              className="w-10 h-10 rounded-full border border-white/10 bg-[#0D0D0D] flex items-center justify-center text-white hover:text-[#00F29D] active:border-[#00F29D] transition-all"
              aria-label="Previous certificate"
            >
              <FiArrowLeft size={16} />
            </button>
